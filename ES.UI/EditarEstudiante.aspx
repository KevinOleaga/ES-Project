<%@ Page Title="" Language="C#" MasterPageFile="~/Login.Master" AutoEventWireup="true" CodeBehind="EditarEstudiante.aspx.cs" Inherits="ES.UI.EditarEstudiante" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
 <div class="alert alert-success" visible="false"  id="mensaje" runat="server">
    ...
    <asp:TextBox ID="txtEmail" CssClass="form-control" runat="server"></asp:TextBox>
             ...
             <br /><br />
             <div class="form-inline">
    <asp:Label ID="lblPadecimientos" runat="server" Text="Padecimiento"></asp:Label>
    ...
    <asp:TextBox ID="txtEncargado" CssClass="form-control" runat="server"></asp:TextBox>
               ...
               <div class="form-inline">
                    <br /><br />
    <asp:Label ID="lbGraduado" runat="server" Text="Graduado"></asp:Label>
                   <asp:CheckBox ID="chGraduado" runat="server" />
        </div>
            
               <div class="form-inline">
                   <br /><br />
    <asp:Label ID="lbAbandono" runat="server" Text="Abandono"></asp:Label>
                   <asp:CheckBox ID="chAbandono" CssClass="form-control" runat="server" />
        </div>
    ...
    <asp:TextBox ID="txtAñoGraduacion" CssClass="form-control" runat="server"> </asp:TextBox>
      ...
      <div class="form-inline col-sm-offset-5">
       ...
       <asp:Button ID="btnRegresar" Onclick="btnRegresar_Click" CssClass="btn btn-primary" runat="server" Text="Regresar" />
        <asp:Button ID="btnModifcar" onclick="btnModificar_Click" CssClass="btn btn-warning" runat="server" Text="Editar" />    
