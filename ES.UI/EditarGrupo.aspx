<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditarGrupo.aspx.cs" Inherits="ES.UI.EditarGrupo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
 <div class="alert alert-success" visible="false"  id="mensaje" runat="server">
    ...
    <asp:Label ID="lbIdMateria"  runat="server" Text="Grupo"></asp:Label>
    <asp:TextBox ID="txtIdGrupo" CssClass="form-control" runat="server"></asp:TextBox>
